package ir.developer.bihingweather.presentation.components
...
import ir.developer.bihingweather.presentation.screens.getScoreColor
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                AsyncImage(
                    model = viewModel.getWeatherIcon(forecast.weather.firstOrNull()?.icon ?: ""),
